...
const Sun = () => (
  ...
  >
    ...
    <div
      ...
      style={{
        background:
          "radial-gradient(circle, rgba(255, 238, 130, 0.4) 0%, transparent 65%)",
        transform: "scale(1.6)",
      }}
    />
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, #D4EDFC 0%, #E8F5FE 25%, #C5E8D5 55%, #A8D5B8 75%, #8BC99A 100%)",
        }}
      />
