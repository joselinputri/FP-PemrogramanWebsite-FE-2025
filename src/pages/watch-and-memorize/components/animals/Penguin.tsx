    ...
    >
      ...
      {isSad ? (
        ...
        <>
          ...
          >
            <polygon
              points="28,24 30,28 34,26 30,30 28,34 26,30 22,26 26,28"
              fill="#FFD700"
            />
            <polygon
              points="72,24 74,28 78,26 74,30 72,34 70,30 66,26 70,28"
              fill="#FFD700"
            />
          </motion.g>
        </>
      ...
      {isFlying && (
        <>
          ...
          {/* Goggle strap */}
          <path
            d="M26 32 Q22 30 20 33"
            stroke="#8B5A2B"
            strokeWidth={2}
            fill="none"
          />
          <path
            d="M74 32 Q78 30 80 33"
            stroke="#8B5A2B"
            strokeWidth={2}
            fill="none"
          />
