...
import { type AnimalProps, safePath } from "./animalData";
...
export const Cow = ({
  ...
  >
    ...
    <path
      d={safePath(
        "M48 48 C52 44 56 48 52 54 C50 58 48 58 46 54 C42 48 44 44 48 48",
      )}
      fill="#D5C6E0"
    />
...
export const Fox = ({
  ...
  >
    ...
    <g>
      ...
      />
      <path
        d={safePath("M34.5 24 L30 14 L38 21.5 Z")}
        fill="#FFB6C1"
        opacity="0.7"
      />
      ...
      />
      <path
        d={safePath("M65.5 24 L70 14 L62 21.5 Z")}
        fill="#FFB6C1"
        opacity="0.7"
      />
    </g>
    ...
    {/* White face markings */}
    <path
      d={safePath("M50 30 L37 47 Q43 51 50 51 Q57 51 63 47 L50 30 Z")}
      fill="#FFFBF5"
    />
    ...
    {isSad ? (
      ...
      <>
        ...
        >
          <polygon
            points="30,29 32,32 35,31 32,34 30,37 28,34 25,31 28,32"
            fill="#FFD700"
          />
          <polygon
            points="70,29 72,32 75,31 72,34 70,37 68,34 65,31 68,32"
            fill="#FFD700"
          />
        </motion.g>
      </>
      ...
      <>
        {[0, 1, 2].map((i) => (
          ...
          >
            <path
              d={safePath(
                "M50 20 C50 18.2 48.2 17.2 47.2 18 C46.2 18.8 46.2 20 47.2 21 L50 23 L52.8 21 C53.8 20 53.8 18.8 52.8 18 C51.8 17.2 50 18.2 50 20",
              )}
              fill="#FF9AA2"
  ...
  >
    ...
    {isSad ? (
      ...
      <>
        ...
        >
          <polygon
            points="20,24 22,27 25,26 22,29 20,32 18,29 15,26 18,27"
            fill="#FFD700"
          />
          <polygon
            points="60,24 62,27 65,26 62,29 60,32 58,29 55,26 58,27"
            fill="#FFD700"
          />
        </motion.g>
      </>
      ...
      <>
        {[0, 1, 2].map((i) => (
          ...
          >
            <path
              d={safePath(
                "M40 16 C40 14.2 38.2 13.2 37.2 14 C36.2 14.8 36.2 16 37.2 17 L40 19 L42.8 17 C43.8 16 43.8 14.8 42.8 14 C41.8 13.2 40 14.2 40 16",
              )}
              fill="#FF69B4"
  ...
  >
    ...
    {isSad ? (
      ...
      <>
        ...
        >
          <polygon
            points="20,21 22,24 25,23 22,26 20,29 18,26 15,23 18,24"
            fill="#FFD700"
          />
          <polygon
            points="60,21 62,24 65,23 62,26 60,29 58,26 55,23 58,24"
            fill="#FFD700"
          />
        </motion.g>
      </>
      ...
      <>
        {[0, 1, 2].map((i) => (
          ...
          >
            <path
              d={safePath(
                "M40 18 C40 16 38 15 37 16 C36 17 36 18 37 19 L40 21 L43 19 C44 18 44 17 43 16 C42 15 40 16 40 18",
              )}
              fill="#FF9AA2"
  ...
  >
    ...
    {isSad ? (
      ...
      <>
        ...
        >
          <polygon
            points="24,21 26,24 29,23 26,26 24,29 22,26 19,23 22,24"
            fill="#FFD700"
          />
          <polygon
            points="56,21 58,24 61,23 58,26 56,29 54,26 51,23 54,24"
            fill="#FFD700"
          />
        </motion.g>
      </>
      ...
      <>
        {[0, 1].map((i) => (
          <motion.path
            key={i}
            d={safePath(
              "M40 22 C40 20 38.5 19 37.5 20 C36.5 21 36.5 22 37.5 23 L40 25 L42.5 23 C43.5 22 43.5 21 42.5 20 C41.5 19 40 20 40 22",
            )}
            fill="#FFB6C1"
            initial={{ opacity: 0, y: 0, scale: 0 }}
            animate={{
      ...
      <>
        {[0, 1].map((i) => (
          <motion.path
            key={i}
            d={safePath(
              "M40 42 C40 40 38.5 39 37.5 40 C36.5 41 36.5 42 37.5 43 L40 45 L42.5 43 C43.5 42 43.5 41 42.5 40 C41.5 39 40 40 40 42",
            )}
            fill="#FFB6C1"
            initial={{ opacity: 0, y: 0, scale: 0 }}
            animate={{
